...
namespace Hotel
{
    public partial class Main : Form
    {
        ...
        private void AbrirFormularioHijo(Form FormHijo)
        {
            ...
            FormHijo.Show();
            lblTituloFormularioHijo.Text = FormHijo.Text;
        ...
        private void ReservacionBtn_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color1);
            AbrirFormularioHijo(new AgregarReservacion());
        }
